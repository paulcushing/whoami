<script context="module">
	export const data = {
		...
		5: {
			neutral: "I am delivered from the power of darkness; Christ brings me into God's kingdom.",
			masculine:
		...
		47: {
			neutral: 'I press toward the mark for the prize of the high calling of God.',
